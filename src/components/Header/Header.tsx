...
const Header = () => {
    ...
    const reloadPage = () => {
        window.location.href = "/movie_proj/#/movies";
    ...
    return (
        <div className={`${css.headerWrapper} ${style ? css.headerWrapperLight : css.headerWrapperDark}`}>
            <div className={css.headerBox}>
                <div className={`${css.logoLink} ${style ? css.logoLinkLight : css.logoLinkDark}`}
                     onClick={reloadPage}>KOMO
                    FILMS
                </div>
                ...
                <button
                    className={`${css.lightModeButton} ${style ? css.lightModeButtonLight : css.lightModeButtonDark}`}
                    onClick={toggleTheme}>
